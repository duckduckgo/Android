...
interface MetricsPixelExtension {
    fun send(metricsPixel: MetricsPixel): Boolean
}
 ...
 * @return true if the pixel was sent, false otherwise.
 */
fun MetricsPixel.send(): Boolean = MetricsPixelExtensionProvider.instance.send(this)
