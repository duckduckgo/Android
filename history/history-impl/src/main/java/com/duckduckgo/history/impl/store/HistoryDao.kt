...
interface HistoryDao {
    ...
    @Query("UPDATE history_entries SET description = :description, h1 = :h1, chunkText = :chunkText WHERE url = :url")
    suspend fun updateMetadata(url: String, description: String?, h1: String?, chunkText: String?)
