...
class WebViewCompatGetNativeSettingsHandler @Inject constructor() : WebViewCompatContentScopeJsMessageHandlersPlugin {
    override fun getJsMessageHandler(): WebViewCompatMessageHandler = object : WebViewCompatMessageHandler {
        ...
        override val methods: List<String> = listOf("getNativeSettings")
    }
}
