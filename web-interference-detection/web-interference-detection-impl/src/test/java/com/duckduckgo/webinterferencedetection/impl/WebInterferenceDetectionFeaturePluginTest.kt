...
class WebInterferenceDetectionFeaturePluginTest {
    ...
    fun whenFeatureNameDoesNotMatchThenReturnFalse() {
        WebInterferenceDetectionFeatureName.values().filter { it != FEATURE_NAME }.forEach {
    ...
    companion object {
        private val FEATURE_NAME = WebInterferenceDetectionFeatureName.WebInterferenceDetection
