...
object SubscriptionsConstants {
    ...
    // URLs
    const val BUY_URL = "https://mtsoy.duck.co/subscriptions?environment=staging"
    const val ACTIVATE_URL = "https://mtsoy.duck.co/subscriptions/activation-flow?environment=staging"
