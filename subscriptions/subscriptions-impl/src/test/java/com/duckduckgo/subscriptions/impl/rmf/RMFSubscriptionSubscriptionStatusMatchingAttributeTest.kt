...
class RMFSubscriptionSubscriptionStatusMatchingAttributeTest {
    @Mock
    private lateinit var subscriptionsManager: SubscriptionsManager

    private lateinit var matcher: RMFSubscriptionSubscriptionStatusMatchingAttribute
    ...
    fun setUp() {
        ...
        matcher = RMFSubscriptionSubscriptionStatusMatchingAttribute(subscriptionsManager)
    }
