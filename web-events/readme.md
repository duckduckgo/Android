...
## Architecture
- **web-events-store**: Room database for eventHub config, webEvents CSS feature config, and pixel state
- **web-events-impl**: Feature plugins, config parser, pixel manager, JS message handler, pixel firing
