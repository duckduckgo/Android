...
import com.duckduckgo.browser.impl.databinding.SheetFireClearDataGranularBinding
    ...
    private fun render(state: GranularFireDialogViewModel.ViewState) {
        binding.apply {
            val tabsDescription = resources.getQuantityString(
                com.duckduckgo.browser.impl.R.plurals.fireDialogOptionTabsDescription,
                state.tabCount,
                state.tabCount,
            )
            ...
            val dataDescription = if (state.isHistoryEnabled) {
                if (state.siteCount > 0) {
                    resources.getQuantityString(
                        com.duckduckgo.browser.impl.R.plurals.fireDialogOptionDataDescription,
                        state.siteCount,
                        state.siteCount,
                    )
                } else {
                    getString(com.duckduckgo.browser.impl.R.string.fireDialogOptionDescriptionNothingToDelete)
                }
            } else {
                getString(com.duckduckgo.browser.impl.R.string.fireDialogOptionDataDescriptionNoHistory)
            }
