...
interface VpnControllerActivityComponent : AndroidInjector<VpnControllerActivity> {
    @Subcomponent.Factory interface Factory : AndroidInjector.Factory<VpnControllerActivity>
}

@ContributesTo(AppScope::class)
interface VpnControllerActivityComponentProvider {
    fun vpnControllerActivityComponentFactory(): VpnControllerActivityComponent.Factory
}

@Module
@ContributesTo(AppScope::class)
abstract class VpnControllerActivityComponentBindingModule {
    @Binds
    @IntoMap
