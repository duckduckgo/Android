...
class DeviceShieldTrackerActivity :
    ...
    private val enableAppTPSwitchListener =
    ...
    companion object {
        ...
        internal fun intent(
            ...
            Intent(context, DeviceShieldTrackerActivity::class.java).apply {
