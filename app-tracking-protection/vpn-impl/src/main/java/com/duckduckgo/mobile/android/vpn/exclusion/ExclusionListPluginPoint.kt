...
interface ExclusionListPluginPoint

fun PluginPoint<ExclusionList>.getExclusionListForFeature(vpnFeature: VpnFeature): ExclusionList {
    return this.getPlugins().filter {
        it.forFeature == vpnFeature
    }[0]
}
