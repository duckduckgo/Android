...
import com.duckduckgo.mobile.android.vpn.databinding.ActivityApptpTransparencyActivityBinding
...
class AppTPTransparencyActivity : DuckDuckGoActivity() {

    // TODO: adjust and launch this when needed
    ...
    private val binding: ActivityApptpTransparencyActivityBinding by viewBinding()
    ...
    private fun launchFeedback() {
        reportBreakage.launch(ReportBreakageScreen.IssueDescriptionForm("apptp", getAppName(), getPackage()))
    }
    ...
    companion object {
        ...
        private const val READ_MORE_ANNOTATION = "read_more_link"
        val GOOGLE_POLICY_URL = "https://policies.google.com/privacy".toUri()
        ...
        internal fun intent(
            ...
            val intent = Intent(context, AppTPTransparencyActivity::class.java)
