...
class VpnRoutes {
    ...
    companion object {
        ...
        val includedRoutes: List<Route> = listOf(
            Route(address = "0.0.0.0", maskWidth = 2, lowAddress = "0.0.0.0", highAddress = "63.255.255.255"),
            ...
            Route(address = "168.0.0.0", maskWidth = 6, lowAddress = "168.0.0.0", highAddress = "171.255.255.255"),
            Route(address = "172.0.0.0", maskWidth = 7, lowAddress = "172.0.0.0", highAddress = "173.255.255.255"),
            ...
            Route(address = "192.0.0.0", maskWidth = 4, lowAddress = "192.0.0.0", highAddress = "207.255.255.255"),
