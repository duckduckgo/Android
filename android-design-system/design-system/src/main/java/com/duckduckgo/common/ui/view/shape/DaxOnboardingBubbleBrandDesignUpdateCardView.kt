...
constructor(
    ...
    override fun onAttachedToWindow() {
        ...
        (layoutParams as? ViewGroup.MarginLayoutParams)?.let { params ->
            if (params.bottomMargin < DaxBubbleBottomEdgeTreatment.ORIGINAL_BOTTOM_ARROW_HEIGHT_DP.toPx() + strokeWidth) {
                params.bottomMargin = DaxBubbleBottomEdgeTreatment.ORIGINAL_BOTTOM_ARROW_HEIGHT_DP.toPx() + strokeWidth
                layoutParams = params
            }
        }
    }
