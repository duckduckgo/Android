...
/**
 * DuckDuckGo destructive ghost button with transparent background.
 *
 * Asana Task: https://app.asana.com/1/137249556945/project/1202857801505092/task/1213826087792403
 * Figma reference: https://www.figma.com/design/BOHDESHODUXK7wSRNBOHdu/%F0%9F%A4%96-Android-Components?node-id=12110-29654
 *
...
fun DaxDestructiveGhostButton(
    ...
    DaxButton(
        ...
        onClick = onClick,
        size = size,
        colors = DaxDestructiveGhostButtonDefaults.colors(),
        rippleConfiguration = DaxDestructiveGhostButtonDefaults.rippleConfiguration(),
...
private object DaxDestructiveGhostButtonDefaults {
...
@PreviewLightDark
@Composable
private fun DaxDestructiveGhostButtonWithIconSmallPreview(
    @PreviewParameter(DaxButtonStateParameterProvider::class) enabled: Boolean,
) {
    PreviewBox {
        DaxDestructiveGhostButton(
...
@PreviewLightDark
@Composable
private fun DaxDestructiveGhostButtonWithIconLargePreview(
    @PreviewParameter(DaxButtonStateParameterProvider::class) enabled: Boolean,
) {
    PreviewBox {
        DaxDestructiveGhostButton(
