...
interface HttpsUpgradeService {
    ...
    fun httpsBloomFilterSpec(): Observable<com.duckduckgo.httpsupgrade.store.HttpsBloomFilterSpec>
    ...
    fun falsePositives(): Call<List<com.duckduckgo.httpsupgrade.store.HttpsFalsePositiveDomain>>
}
