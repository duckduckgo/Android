...
package com.duckduckgo.experiments.impl.di
...
object ExperimentsModule {
    ...
    @Provides
    @SingleInstanceIn(AppScope::class)
    fun providesExperimentVariantDao(experimentsDatabase: ExperimentsDatabase): ExperimentVariantDao {
        return experimentsDatabase.experimentVariantsDao()
    }
}
