...
/**
 * This class is used to provide one of the two different version of New Tab Page
...
interface NewTabPagePlugin {
    ...
    /** Name of the new tab page */
    val name: String

    /**
     * This method returns a [View] that will be used as the New Tab Page content
     * @return [View]
     */
