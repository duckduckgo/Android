 ...
 * about the VPN state. This is generally done when an event happens that requires an AppTP
 * bugreport to be sent, eg. user unprotects an app or reports breakage.
 */
