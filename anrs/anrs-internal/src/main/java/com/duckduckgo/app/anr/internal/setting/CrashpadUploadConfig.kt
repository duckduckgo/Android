...
class CrashpadUploadConfig @Inject constructor(context: Context) {

    private val prefs = context.getSharedPreferences("crashpad_upload_config", Context.MODE_PRIVATE)
