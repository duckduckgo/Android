...
enum class NtpAfterIdlePixelName(override val pixelName: String) : Pixel.PixelName {
    ...
    TIMEOUT_SELECTED_1("m_ntp_after_idle_timeout_selected_1"),
    TIMEOUT_SELECTED_1_DAILY("m_ntp_after_idle_timeout_selected_daily_1"),
...
object NtpAfterIdlePixels {
    ...
    fun timeoutPixelsForSeconds(seconds: Long): Pair<NtpAfterIdlePixelName, NtpAfterIdlePixelName>? = when (seconds) {
        1L -> Pair(NtpAfterIdlePixelName.TIMEOUT_SELECTED_1, NtpAfterIdlePixelName.TIMEOUT_SELECTED_1_DAILY)
