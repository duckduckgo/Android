...
import com.duckduckgo.serp.logos.impl.di.FavouriteSerpLogo
...
class FavouriteSerpLogoPrefsDataStore @Inject constructor(
    @FavouriteSerpLogo private val store: DataStore<Preferences>,
) : FavouriteSerpLogoDataStore {

    override val favouriteLogo: Flow<String?> = store.data.map { prefs ->
