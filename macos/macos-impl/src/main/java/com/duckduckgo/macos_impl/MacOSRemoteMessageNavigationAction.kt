...
class MacOSRemoteMessageNavigationAction @Inject constructor(
    private val context: Context,
    private val globalActivityStarter: GlobalActivityStarter,
) : MessageActionMapperPlugin {

    override fun evaluate(jsonMessageAction: JsonMessageAction): Action? {
        return if (jsonMessageAction.type == APP_NAVIGATION.jsonValue && jsonMessageAction.value == "macOS") {
            val intent = globalActivityStarter.startIntent(context, MacOsScreenWithEmptyParams) ?: return null
