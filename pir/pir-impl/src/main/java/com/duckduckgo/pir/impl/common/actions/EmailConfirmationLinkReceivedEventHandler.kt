...
class EmailConfirmationLinkReceivedEventHandler @Inject constructor() : EventHandler {
    override val event: KClass<out Event> = EmailConfirmationLinkReceived::class
