...
class PirWebContentScopeJsMessageHandler @Inject constructor() : ContentScopeJsMessageHandlersPlugin {
    override fun getJsMessageHandler(): JsMessageHandler = object : JsMessageHandler {
        override fun process(jsMessage: JsMessage, secret: String, jsMessageCallback: JsMessageCallback?) {
            logcat { "PirWebContentScopeJsMessageHandler process: featureName=$featureName, method=${jsMessage.method}, id=${jsMessage.id}, params=${jsMessage.params}" }
        ...
        override val featureName: String = "dbpui"
