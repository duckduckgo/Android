...
class PirWebRemoveAddressAtIndexFromCurrentUserProfileMessageHandlerTest {
    ...
    fun whenMessageIsSetThenReturnsCorrectMessage() {
        assertEquals(
            PirDashboardWebMessages.REMOVE_ADDRESS_AT_INDEX_FROM_CURRENT_USER_PROFILE,
            testee.message,
        )
    }

    @Test
    fun whenProcessWithValidIndexThenRemovesAddressAndSendsSuccessResponse() {
        // Given
    ...
    @Test
    fun whenProcessWithValidPositiveIndexThenRemovesAddressAndSendsSuccessResponse() {
        // Given
        val jsMessage = createJsMessage(
            paramsJson = """{"index": 2}""",
            method = PirDashboardWebMessages.REMOVE_ADDRESS_AT_INDEX_FROM_CURRENT_USER_PROFILE,
