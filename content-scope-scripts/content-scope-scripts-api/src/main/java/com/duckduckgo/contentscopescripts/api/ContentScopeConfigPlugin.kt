...
/**
 * Implement this interface and contribute it as a multibinding to provide feature config/preferences that will be sent to C-S-S.
 *
 * Usage:
 *
 * ```kotlin
 * @ContributesMultibinding(AppScope::class)
 * class MuFeaturePlugin @Inject constructor(...) : ContentScopeConfigPlugin {
 *
 * }
 * ```
 */
