...
class WebViewProfileManagerInitializer @Inject constructor(
    private val profileManager: WebViewProfileManager,
    @param:AppCoroutineScope private val appCoroutineScope: CoroutineScope,
) : MainProcessLifecycleObserver {

    override fun onCreate(owner: LifecycleOwner) {
        appCoroutineScope.launch { profileManager.initialize() }
    }
}
