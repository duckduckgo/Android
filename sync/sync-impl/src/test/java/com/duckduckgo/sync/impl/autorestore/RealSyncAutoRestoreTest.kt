...
class RealSyncAutoRestoreTest {
    ...
    fun setup() = runTest {
        ...
        configureRestoreOnReinstallEnabled(true)
    ...
    @Test
    fun whenRestoreOnReinstallDisabledThenCanRestoreReturnsFalse() = runTest {
        configureAutoRestoreEnabled(true)
        configureRestoreOnReinstallEnabled(false)
    ...
    @Test
    fun whenRetrieveRecoveryCodeReturnsNullThenDoesNotCallProcessCode() = runTest {
        configureRetrieveSuccess(payload = null)
    ...
    private suspend fun configureRestoreOnReinstallEnabled(enabled: Boolean) {
        whenever(manager.isRestoreOnReinstallEnabled()).thenReturn(enabled)
    }
    ...
    private suspend fun configureRetrieveFailure() {
        whenever(manager.retrieveRecoveryPayload()).thenReturn(null)
    }
}
