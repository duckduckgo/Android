...
@StringRes
internal fun exchangeV2ConfirmationMessageRes(
    unknownPeer: Boolean,
    peerKind: PeerKind?,
): Int {
...
internal fun Context.exchangeV2ConfirmationMessage(
    peerName: String?,
    peerKind: PeerKind?,
): String {
    val res = exchangeV2ConfirmationMessageRes(unknownPeer = peerName.isNullOrBlank(), peerKind = peerKind)
