...
internal data class ExchangeV2PairingErrorContent(
 ...
 */
internal fun Int.toExchangeV2PairingError(): ExchangeV2PairingErrorContent = when (this) {
    PAIRING_REJECTED.code -> ExchangeV2PairingErrorContent(
        title = R.string.sync_v2_error_pairing_rejected,
        message = R.string.sync_v2_error_try_again,
    )
    PAIRING_CANCELLED.code -> ExchangeV2PairingErrorContent(
        title = R.string.sync_v2_error_pairing_canceled,
        message = null,
    )
    THIRD_PARTY_ALREADY_UPGRADED.code -> ExchangeV2PairingErrorContent(
        title = R.string.sync_v2_error_pairing_failed,
        message = R.string.sync_v2_error_third_party_already_upgraded,
    )
    else -> ExchangeV2PairingErrorContent(
        title = R.string.sync_v2_error_pairing_failed,
        message = R.string.sync_v2_error_try_again,
    )
}
...
internal val exchangeV2UpgradeRequiredError = ExchangeV2PairingErrorContent(
...
internal val exchangeV2AlreadyPairedError = ExchangeV2PairingErrorContent(
 ...
 * [ExchangeV2PairingErrorContent.message].
 */
internal fun Context.showExchangeV2PairingError(
    content: ExchangeV2PairingErrorContent,
    onDismissed: () -> Unit,
) {
