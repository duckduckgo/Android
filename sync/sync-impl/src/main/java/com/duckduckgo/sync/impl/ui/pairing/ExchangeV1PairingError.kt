...
internal data class ExchangeV1PairingErrorContent(
 ...
 */
internal fun Error.toExchangeV1PairingError(): ExchangeV1PairingErrorContent {
    ...
    return ExchangeV1PairingErrorContent(message, reason)
}

/**
 * Renders a v1 pairing error dialog: hardcoded title, and a provided message with a reason.
 */
internal fun Context.showExchangeV1PairingError(
    content: ExchangeV1PairingErrorContent,
    onDismissed: () -> Unit,
) {
