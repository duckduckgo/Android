...
import com.duckduckgo.sync.impl.databinding.ViewOtherPlatformsListItemBinding
...
internal class GetOnOtherPlatformsListItem @JvmOverloads constructor(
    ...
    private val binding = ViewOtherPlatformsListItemBinding.inflate(LayoutInflater.from(context), this)

    fun setState(
        isNewDesktopBrowserAvailable: Boolean,
    ) {
