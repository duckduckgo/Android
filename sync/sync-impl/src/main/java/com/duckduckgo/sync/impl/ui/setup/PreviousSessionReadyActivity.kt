...
import com.duckduckgo.sync.impl.databinding.ActivityPreviousSessionReadyBinding
import com.duckduckgo.sync.impl.ui.SyncEntryPoint
import com.duckduckgo.sync.impl.ui.setup.PreviousSessionReadyViewModel.Command
import com.duckduckgo.sync.impl.ui.setup.PreviousSessionReadyViewModel.Factory
import com.duckduckgo.sync.impl.ui.setup.PreviousSessionReadyViewModel.Factory.Provider
...
class PreviousSessionReadyActivity : DuckDuckGoActivity() {
    private val binding by viewBinding<ActivityPreviousSessionReadyBinding>()
