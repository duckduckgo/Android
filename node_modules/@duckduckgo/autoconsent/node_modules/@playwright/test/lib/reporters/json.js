...
class JSONReporter {
  ...
  _serializeTestResult(result, test) {
    ...
    if ((_result$error = result.error) !== null && _result$error !== void 0 && _result$error.stack) jsonResult.errorLocation = (0, _base.prepareErrorStack)(result.error.stack, test.location.file).location;
    return jsonResult;
  }
