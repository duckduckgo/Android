...
process.stdout.write = chunk => {
  ...
  const outPayload = {
    testId: (_workerRunner = workerRunner) === null || _workerRunner === void 0 ? void 0 : (_workerRunner$_curren = _workerRunner._currentTest) === null || _workerRunner$_curren === void 0 ? void 0 : _workerRunner$_curren._test._id,
    ...chunkToParams(chunk)
  };
...
if (!process.env.PW_RUNNER_DEBUG) {
  process.stderr.write = chunk => {
    ...
    const outPayload = {
      testId: (_workerRunner2 = workerRunner) === null || _workerRunner2 === void 0 ? void 0 : (_workerRunner2$_curre = _workerRunner2._currentTest) === null || _workerRunner2$_curre === void 0 ? void 0 : _workerRunner2$_curre._test._id,
      ...chunkToParams(chunk)
    };
...
process.on('message', async message => {
  if (message.method === 'init') {
    ...
    for (const event of ['testBegin', 'testEnd', 'stepBegin', 'stepEnd', 'done', 'teardownErrors']) workerRunner.on(event, sendMessageToParent.bind(null, event));
...
async function gracefullyCloseAndExit() {
  ...
  try {
    ...
    try {
      const payload = {
        fatalErrors: [(0, _util2.serializeError)(e)]
      };
      process.send({
