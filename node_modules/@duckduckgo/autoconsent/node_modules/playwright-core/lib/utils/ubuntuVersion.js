...
function parseUbuntuVersion(osReleaseText) {
  var _fields$get, _fields$get2, _fields$get3;

  const fields = parseOSReleaseText(osReleaseText); // For Linux mint

  if (fields.get('distrib_id') && ((_fields$get = fields.get('distrib_id')) === null || _fields$get === void 0 ? void 0 : _fields$get.toLowerCase()) === 'ubuntu') return fields.get('distrib_release') || ''; // For Pop!_OS

  if (fields.get('id') && ((_fields$get2 = fields.get('id')) === null || _fields$get2 === void 0 ? void 0 : _fields$get2.toLowerCase()) === 'pop') return fields.get('version_id') || '';
  if (!fields.get('name') || ((_fields$get3 = fields.get('name')) === null || _fields$get3 === void 0 ? void 0 : _fields$get3.toLowerCase()) !== 'ubuntu') return '';
