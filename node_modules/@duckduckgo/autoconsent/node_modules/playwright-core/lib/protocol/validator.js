...
function createScheme(tChannel) {
  ...
  scheme.RecordHarOptions = (0, _validatorPrimitives.tObject)({
    path: _validatorPrimitives.tString,
  ...
  scheme.LocalUtilsHarOpenParams = (0, _validatorPrimitives.tObject)({
    file: _validatorPrimitives.tString
  });
  scheme.LocalUtilsHarLookupParams = (0, _validatorPrimitives.tObject)({
    harId: _validatorPrimitives.tString,
    url: _validatorPrimitives.tString,
    method: _validatorPrimitives.tString,
    headers: (0, _validatorPrimitives.tArray)(tType('NameValue')),
    postData: (0, _validatorPrimitives.tOptional)(_validatorPrimitives.tString),
    isNavigationRequest: _validatorPrimitives.tBoolean
  });
  scheme.LocalUtilsHarCloseParams = (0, _validatorPrimitives.tObject)({
    harId: _validatorPrimitives.tString
  });
  scheme.LocalUtilsHarUnzipParams = (0, _validatorPrimitives.tObject)({
    zipFile: _validatorPrimitives.tString,
  ...
  scheme.BrowserTypeLaunchPersistentContextParams = (0, _validatorPrimitives.tObject)({
    ...
    recordHar: (0, _validatorPrimitives.tOptional)(tType('RecordHarOptions')),
  ...
  scheme.BrowserContextHarStartParams = (0, _validatorPrimitives.tObject)({
    page: (0, _validatorPrimitives.tOptional)(tChannel('Page')),
    options: tType('RecordHarOptions')
  });
  scheme.BrowserContextHarExportParams = (0, _validatorPrimitives.tObject)({
  ...
  scheme.RouteRedirectNavigationRequestParams = (0, _validatorPrimitives.tObject)({
    url: _validatorPrimitives.tString
  });
