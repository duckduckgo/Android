...
class InterfacePrototype {
  ...
  preAttachTooltip(topContextData, input, form) {
    ...
    const checks = [topContextData.inputType === 'credentials.password', this.settings.featureToggles.password_generation, form.isSignup];
...
class Form {
  ...
  autofillInput(input, string, dataType) {
    ...
    if (dataType === 'identities' &&
    // only for identities
    input.nodeName !== 'SELECT' && input.value !== '' &&
    // if the input is not empty
    this.activeInput !== input &&
    // and this is not the active input
...
},{"../autofill-utils.js":51,"../constants.js":54,"./FormAnalyzer.js":24,"./formatters.js":26,"./inputStyles.js":27,"./inputTypeConfig.js":28,"./matching.js":33}],24:[function(require,module,exports){
"use strict";
...
const supportedCredentialsSubtypes = /** @type {const} */['password', 'username'];
...
},{"../../../packages/device-api/index.js":2,"../../../packages/messaging/messaging.js":5,"../__generated__/deviceApiCalls.js":55}],60:[function(require,module,exports){
"use strict";
