...
body {
    ...
    &.body--theme-dark {
        background-color:  $color--dark-theme-border;
...
.border-light--top {
    ...
    .body--theme-dark & {
        border-top: 1px solid  $color--dark-theme-border;
    }
}
...
.border-light--bottom {
    ...
    .body--theme-dark & {
        border-bottom: 1px solid  $color--dark-theme-border;
    }
}
...
/* Padding */
.padded {
    padding: $card--padded $card--padded--side;

    // the extra left/right padding should not affect the extensions
    .environment--browser & {
        padding: $card--padded $card--padded;
    }
}
