...
describe('Site view', () => {
    ...
    describe('when protection is enabled', () => {
        describe('and locale is changed', () => {
            beforeEach(() => {
                dataResolve(generateData({ permissions: [], site: { allowlisted: false }, locale: 'cimode' }))
            })
        ...
        describe('and connection is secure', () => {
            beforeEach(() => {
                dataResolve(generateData({ permissions: [], site: { allowlisted: false } }))
            })
        ...
        describe('and connection is insecure', () => {
            beforeEach(() => {
                dataResolve(generateData({ permissions: [], site: { allowlisted: false }, isSecure: false }))
            })
        ...
        describe('and connection was upgraded', () => {
            beforeEach(() => {
                dataResolve(generateData({ permissions: [], site: { allowlisted: false }, upgradedHttps: true }))
            })
        ...
        describe('and no trackers are found', () => {
            beforeEach(() => {
                const data = generateData({ permissions: [], site: { allowlisted: false } })
                data.tab.trackers = {}
                data.tab.trackersBlocked = {}
                dataResolve(data)
            })
        ...
        describe('and site is owned by tracking network', () => {
            beforeEach(() => {
                const data = generateData({ permissions: [], site: { allowlisted: false }, parentEntity: { prevalence: 90.123 } })
                dataResolve(data)
            })
    ...
    describe('when protection is not enabled', () => {
        describe('and locale is changed', () => {
            beforeEach(() => {
                dataResolve(generateData({ permissions: [], site: { allowlisted: true }, locale: 'cimode' }))
            })
        ...
        describe('and connection is secure', () => {
            beforeEach(() => {
                dataResolve(generateData({ permissions: [], site: { allowlisted: true }, isSecure: true }))
            })
        ...
        describe('and connection is insecure', () => {
            beforeEach(() => {
                dataResolve(generateData({ permissions: [], site: { allowlisted: true }, isSecure: false }))
            })
        ...
        describe('and connection was upgraded', () => {
            beforeEach(() => {
                dataResolve(generateData({ permissions: [], site: { allowlisted: true }, upgradedHttps: true }))
            })
        ...
        describe('and no trackers are found', () => {
            beforeEach(() => {
                const data = generateData({ permissions: [], site: { allowlisted: true } })
                data.tab.trackers = {}
                data.tab.trackersBlocked = {}
                dataResolve(data)
            })
        ...
        describe('and site is owned by tracking network', () => {
            beforeEach(() => {
                const data = generateData({ permissions: [], site: { allowlisted: true }, parentEntity: { prevalence: 90.123 } })
                dataResolve(data)
            })
