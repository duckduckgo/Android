...
Site.prototype = window.$.extend({},
    Parent.prototype,
    {
        ...
        initAllowlisted: function (allowListValue, denyListValue) {
            ...
            this.isBroken = Boolean(this.tab.site.isBroken || !this.tab.site.enabledFeatures?.includes('contentBlocking'))
        ...
        toggleAllowlist: function () {
            ...
            if (this.tab && this.tab.site) {
                if (this.isBroken) {
                    ...
                    fetches.push(this.setList('denylisted', this.tab.site.domain, this.isDenylisted))
                } else {
                    ...
                    fetches.push(this.setList('denylisted', this.tab.site.domain, false))
                    this.initAllowlisted(!this.isAllowlisted)
                    fetches.push(this.setList('allowlisted', this.tab.site.domain, this.isAllowlisted))
                }
            }
            Promise.all(fetches)
                .then(() => this.fetch({ postToggleAllowlist: { id: this.tab.id } }))
