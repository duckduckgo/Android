...
.mdc-switch.mdc-switch--selected:enabled .mdc-switch__handle::after {
  background: #678FFF;
  /* @alternate */
  background: var(--mdc-switch-selected-handle-color, var(--mdc-theme-primary, #678FFF));
}

.mdc-switch.mdc-switch--selected:enabled:hover:not(:focus):not(:active) .mdc-switch__handle::after {
  background: #676d80;
  /* @alternate */
  background: var(--mdc-switch-selected-hover-handle-color, #676d80);
}

.mdc-switch.mdc-switch--selected:enabled:focus:not(:active) .mdc-switch__handle::after {
  background: #676d80;
  /* @alternate */
  background: var(--mdc-switch-selected-focus-handle-color, #676d80);
}

.mdc-switch.mdc-switch--selected:enabled:active .mdc-switch__handle::after {
  background: #676d80;
  /* @alternate */
  background: var(--mdc-switch-selected-pressed-handle-color, #676d80);
}
...
.mdc-switch.mdc-switch--selected:enabled .mdc-switch__icon {
  fill: #000;
  /* @alternate */
  fill: var(--mdc-switch-selected-icon-color, var(--mdc-theme-on-primary, #000));
}

.mdc-switch.mdc-switch--selected:disabled .mdc-switch__icon {
  fill: #000;
  /* @alternate */
  fill: var(--mdc-switch-disabled-selected-icon-color, var(--mdc-theme-on-primary, #000));
}

.mdc-switch.mdc-switch--unselected:enabled .mdc-switch__icon {
  fill: #000;
  /* @alternate */
  fill: var(--mdc-switch-unselected-icon-color, var(--mdc-theme-on-primary, #000));
}

.mdc-switch.mdc-switch--unselected:disabled .mdc-switch__icon {
  fill: #000;
  /* @alternate */
  fill: var(--mdc-switch-disabled-unselected-icon-color, var(--mdc-theme-on-primary, #000));
}
...
.mdc-switch.mdc-switch--selected:enabled:hover:not(:focus) .mdc-switch__ripple::after {
  ...
  /* @alternate */
  background-color: var(--mdc-switch-selected-hover-state-layer-color, var(--mdc-theme-primary, #678FFF));
}
...
.mdc-switch.mdc-switch--selected:enabled:focus .mdc-switch__ripple::after {
  background-color: #678FFF;
  /* @alternate */
  background-color: var(--mdc-switch-selected-focus-state-layer-color, var(--mdc-theme-primary, #678FFF));
}
...
.mdc-switch.mdc-switch--selected:enabled:active .mdc-switch__ripple::after {
  background-color: #678FFF;
  /* @alternate */
  background-color: var(--mdc-switch-selected-pressed-state-layer-color, var(--mdc-theme-primary, #678FFF));
}
...
.mdc-switch:enabled .mdc-switch__track::after {
  background: #d9e3ff;
  /* @alternate */
  background: var(--mdc-switch-selected-track-color, #d9e3ff);
}

.mdc-switch:enabled:hover:not(:focus):not(:active) .mdc-switch__track::after {
  background: #d9e3ff;
  /* @alternate */
  background: var(--mdc-switch-selected-hover-track-color, #d9e3ff);
}

.mdc-switch:enabled:focus:not(:active) .mdc-switch__track::after {
  background: #d9e3ff;
  /* @alternate */
  background: var(--mdc-switch-selected-focus-track-color, #d9e3ff);
}

.mdc-switch:enabled:active .mdc-switch__track::after {
  background: #d9e3ff;
  /* @alternate */
  background: var(--mdc-switch-selected-pressed-track-color, #d9e3ff);
}
...
.environment--ios body, body.environment--android {
  font-size: 16px;
}
...
.environment--ios h1, .environment--android h1, .environment--ios h2, .environment--android h2, .environment--ios h3, .environment--android h3, .environment--ios h4, .environment--android h4, .environment--ios h5, .environment--android h5, .environment--ios h5, .environment--android h5, .environment--ios p, .environment--android p, .environment--ios div, .environment--android div {
  font-size: 16px;
}
...
.environment--ios body, .environment--android body,
.environment--ios input,
.environment--android input,
.environment--ios textarea,
.environment--android textarea,
.environment--ios select,
.environment--android select {
  font-size: 16px;
}
...
.body--theme-dark .border-light--top {
...
.body--theme-dark .border-light--bottom {
...
.body--theme-dark .border--bottom--inner:after {
  border-bottom: 1px solid rgba(255, 255, 255, 0.12);
}
...
.body--theme-dark .border--top--inner:before {
  border-top: 1px solid rgba(255, 255, 255, 0.12);
}
...
.border-light--bottom--inner:after {
  content: "";
  border-bottom: 1px solid rgba(0, 0, 0, 0.06);
  position: absolute;
  bottom: 0;
...
.body--theme-dark .border-light--bottom--inner:after {
  border-bottom: 1px solid #444;
}
...
.body--theme-dark .border-light--top--inner:before {
  border-top: 1px solid #444;
}
...
.body--theme-dark.environment--android .card {
...
.body--theme-dark .icon.icon__arrow {
  background-image: url("../../img/refresh-assets/chevron--light.svg");
}
.icon.icon__arrow.icon__arrow--left {
  transform: rotate(180deg);
}
.icon.icon__arrow.icon__arrow--large {
  width: 7px;
  margin-top: -20px;
  background-image: url("../../img/arrow--large.svg");
}
.icon.icon__back-arrow {
  background-size: contain;
  background-image: url("../../img/refresh-assets/back-arrow.svg");
}
.body--theme-dark .icon.icon__back-arrow {
  background-image: url("../../img/refresh-assets/back-arrow--light.svg");
}
.environment--android .icon.icon__back-arrow {
  background-image: url("../../img/refresh-assets/back-arrow-android.svg");
}
.body--theme-dark.environment--android .icon.icon__back-arrow {
  background-image: url("../../img/refresh-assets/back-arrow-android--light.svg");
}
.environment--ios .icon.icon__back-arrow {
  background-image: url("../../img/refresh-assets/back-chevron-ios.svg");
  width: 20px;
  height: 20px;
}
.environment--ios .icon.icon__back-arrow:before {
...
.body--theme-dark.environment--ios .icon.icon__back-arrow {
  background-image: url("../../img/refresh-assets/back-chevron-ios--light.svg");
}
.icon.icon__settings {
  width: 16px;
  height: 16px;
  background-image: url("../../img/settings-gear@2x.png");
}
.icon.icon__error {
  width: 24px;
  height: 24px;
...
.modal-box .modal-box__popout__body {
  width: 0;
  height: 0;
