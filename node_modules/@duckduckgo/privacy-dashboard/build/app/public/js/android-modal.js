...
`;
  ...
  // v2/android-modal.js
  var AndroidModal = class extends h3 {
    constructor() {
      super(...arguments);
    ...
    show() {
      ...
      console.log("will show items", this.items);
      elem?.show();
    }
    _onClose(e6) {
      ...
      this.dispatchEvent(new CustomEvent("did-close", { detail: { value: name } }));
    }
    render() {
      return ke`
  ...
  __publicField(AndroidModal, "properties", {
    items: {
      type: Array
    },
    title: {
  ...
  __publicField(AndroidModal, "styles", [
    i`
            :root {
                text-align: left;
            }
  ...
  customElements.define("ddg-android-modal", AndroidModal);
})();
