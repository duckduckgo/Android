...
enum class NetPSetting(override val value: String, override val defaultValue: Boolean = false) : SettingName {
    ExcludeSystemApps("badHealthMitigation", defaultValue = false),
}
