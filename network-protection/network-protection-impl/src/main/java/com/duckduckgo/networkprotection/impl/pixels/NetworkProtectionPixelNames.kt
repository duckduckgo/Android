...
enum class NetworkProtectionPixelNames(
    ...
    NETP_TERMS_SHOWN_DAILY("m_netp_imp_terms_d"),
    NETP_TERMS_ACCEPTED("m_netp_ev_terms_accepted_c"),
    NETP_TERMS_ACCEPTED_DAILY("m_netp_ev_terms_accepted_d"),
    NETP_WAITLIST_NOTIFICATION_SHOWN_DAILY("m_netp_ev_waitlist_notification_shown_d"),
    NETP_WAITLIST_NOTIFICATION_SHOWN("m_netp_ev_waitlist_notification_shown_c"),
    NETP_WAITLIST_NOTIFICATION_CANCELLED_DAILY("m_netp_ev_waitlist_notification_cancelled_d"),
    ...
    NETP_ACCESS_REVOKED_DIALOG_SHOWN_DAILY("m._netp_ev_vpn_access_revoked_dialog_shown_d", enqueue = true),
