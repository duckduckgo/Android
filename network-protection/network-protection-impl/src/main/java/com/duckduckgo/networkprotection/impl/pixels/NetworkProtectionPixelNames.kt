...
enum class NetworkProtectionPixelNames(
    ...
    NETP_ACCESS_REVOKED_DIALOG_SUBSCRIBE_CLICKED_DAILY("m_netp_ev_vpn_access_revoked_dialog_subscribe_clicked_d", enqueue = true),
    NETP_ACCESS_REVOKED_DIALOG_DISMISS_CLICKED("m_netp_ev_vpn_access_revoked_dialog_dismiss_clicked_c", enqueue = true),
    NETP_ACCESS_REVOKED_DIALOG_DISMISS_CLICKED_DAILY("m_netp_ev_vpn_access_revoked_dialog_dismiss_clicked_d", enqueue = true),
    NETP_SUBSCRIPTION_PROMOTION_DIALOG_SHOWN("m_netp_ev_privacy_pro_promotion_dialog_shown_c", enqueue = true),
    NETP_SUBSCRIPTION_PROMOTION_DIALOG_SHOWN_DAILY("m_netp_ev_privacy_pro_promotion_dialog_shown_d", enqueue = true),
    NETP_BETA_STOPPED_WHEN_SUBSCRIPTION_UPDATED_AND_ENABLED("m_netp_ev_vpn_beta_stopped_when_privacy_pro_enabled_c", enqueue = true),
    NETP_BETA_STOPPED_WHEN_SUBSCRIPTION_UPDATED_AND_ENABLED_DAILY("m_netp_ev_vpn_beta_stopped_when_privacy_pro_enabled_d", enqueue = true),
