...
class FakeNetPRemoteFeatureFactory private constructor() {
    companion object {
        fun create(): NetPRemoteFeature {
            return FeatureToggles.Builder()
                ...
                .featureName("fakeNetPRemoteFeature")
                .build()
                .create(NetPRemoteFeature::class.java)
        }
    }
}
