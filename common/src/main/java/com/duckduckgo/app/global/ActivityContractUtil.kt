...
/**
 * Delegate to get contract input parameters from custom Object
 * Using like following:
 * ```
 *  val someInputParams by contractParams<InputParamType>()
 * ```
 */
inline fun <reified I : Any> Activity.contractParams(): Lazy<I> =
    lazy { this.intent.getFromExtraForClass(SimpleActivityResultContract.EXTRA_INPUT, I::class) as I }
