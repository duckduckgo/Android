...
class TrackerBlockingVpnService :
    ...
    @Inject lateinit var tunPacketReaderFactory: TunPacketReader.Factory

    @Inject lateinit var tunPacketWriterFactory: TunPacketWriter.Factory
    ...
    private suspend fun stopVpn(reason: VpnStopReason) =
        withContext(Dispatchers.IO) {
