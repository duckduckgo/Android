...
class Ipv6PrivacySettingPlugin @Inject constructor(
    ...
    override val settingName: SettingName = AppTpSetting.Ipv6Support

    private data class JsonConfigModel(
        val state: String?,
    ) {
        fun toStoreModel(): AppTpConfig.Ipv6Config {
            return AppTpConfig.Ipv6Config(state == "enabled")
        }
    }
}
