...
class PrivateDnsSettingPlugin @Inject constructor(
    ...
    override val settingName: SettingName = AppTpSetting.PrivateDnsSupport

    private data class JsonConfigModel(
        val state: String?,
    ) {
        fun toStoreModel(): AppTpConfig.PrivateDnsConfig {
            return AppTpConfig.PrivateDnsConfig(state == "enabled")
        }
    }
}
