...
interface SharedPreferencesProvider {
     ...
     * @param originName Name of the origin shared preferences
     * @param destinationName Name of the destination shared preferences. Defaults to [originName]
     *
     *
     * @return the encrypted shared preferences or null if there was any error (eg. device doesn't support it)
     */
    suspend fun getMigratedEncryptedSharedPreferences(originName: String, destinationName: String = originName): SharedPreferences?
}
