...
import com.duckduckgo.autoconsent.impl.remoteconfig.AutoconsentFeatureModels.CompactRuleIndex
...
class InitMessageHandlerPluginTest {
    ...
    private fun invokeFilterCompactRules(rules: CompactRules, url: String): InitMessageHandlerPlugin.AutoconsentRuleset {
