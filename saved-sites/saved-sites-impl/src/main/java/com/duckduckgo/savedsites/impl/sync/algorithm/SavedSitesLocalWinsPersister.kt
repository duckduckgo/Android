    ...
    override fun processBookmarkFolder(
        ...
        if (localFolder != null) {
            if (folder.isDeleted()) {
                ...
                Timber.d("Sync-Saved-Sites-Persister: folder ${localFolder.id} exists locally, nothing to do")
            }
        } else {
            if (folder.isDeleted()) {
    ...
    override fun processBookmark(
        ...
        if (storedBookmark != null) {
            if (bookmark.isDeleted()) {
                ...
                Timber.d("Sync-Saved-Sites-Persister: remote bookmark ${bookmark.id} exists locally, nothing to do")
            }
        } else {
            if (bookmark.isDeleted()) {
    ...
    override fun processFavourite(
        ...
        if (storedFavorite != null) {
            if (favourite.isDeleted()) {
                ...
                Timber.d("Sync-Saved-Sites-Persister: remote favourite ${favourite.id} exists locally, nothing to do")
            }
        } else {
            if (favourite.isDeleted()) {
