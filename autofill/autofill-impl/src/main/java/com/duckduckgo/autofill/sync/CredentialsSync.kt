...
class CredentialsSync @Inject constructor(
    ...
    suspend fun getUpdatesSince(since: Iso8601String): List<LoginCredentialEntry> {
        ...
        val filteredChanges = allChanges.filterInvalidItems()
    ...
    private fun List<LoginCredentialEntry>.filterInvalidItems(): List<LoginCredentialEntry> {
        return this.filter {
    ...
    companion object {
        ...
        const val MAX_ENCRYPTED_DOMAIN_LENGTH = 1000
        const val MAX_ENCRYPTED_USERNAME_LENGTH = 1000
        const val MAX_ENCRYPTED_PASSWORD_LENGTH = 1000
        const val MAX_ENCRYPTED_NOTES_LENGTH = 10000
    }
}
