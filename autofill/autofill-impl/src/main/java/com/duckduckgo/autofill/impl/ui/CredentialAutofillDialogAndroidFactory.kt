...
import com.duckduckgo.autofill.impl.ui.credential.passwordgeneration.AutofillGeneratePasswordDialogFragment
...
class CredentialAutofillDialogAndroidFactory @Inject constructor() : CredentialAutofillDialogFactory {
    ...
    override fun autofillGeneratePasswordDialog(
        ...
        return AutofillGeneratePasswordDialogFragment.instance(url, generatedPassword, tabId)
    }
}
