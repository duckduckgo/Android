...
class CredentialAutofillDialogAndroidFactory @Inject constructor() : CredentialAutofillDialogFactory {
    ...
    override fun autofillImportPasswordsDialog(importSource: AutofillImportLaunchSource, tabId: String): DialogFragment {
        return ImportFromGooglePasswordsDialog.instance(importSource = importSource, tabId = tabId)
    }
}
