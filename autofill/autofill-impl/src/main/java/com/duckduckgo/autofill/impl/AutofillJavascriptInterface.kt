...
class AutofillStoredBackJavascriptInterface @Inject constructor(
    ...
    override fun getAutofillData(requestString: String) {
        ...
        getAutofillDataJob += coroutineScope.launch(dispatcherProvider.computation()) {
    ...
    fun storeFormData(data: String) {
        ...
        storeFormDataJob += coroutineScope.launch(dispatcherProvider.computation()) {
    ...
    override fun injectCredentials(credentials: LoginCredentials) {
        ...
        injectCredentialsJob += coroutineScope.launch(dispatcherProvider.computation()) {
