...
class PasswordEventResolverTest {
    ...
    fun whenNoAutoSavedLoginAndNotAutogeneratedCredentialsThenPromptUserToSave() {
        ...
        val actions = testee.decide(autoSavedLogin, autogenerated = false)
        actions.assertExpectedActions(PromptToSave, DiscardAutoLoginId)
    }

    @Test
    fun whenNoAutoSavedLoginAndAutogeneratedCredentialsThenSilentlySave() {
        val autoSavedLogin = null
        val actions = testee.decide(autoSavedLogin, autogenerated = true)
        actions.assertExpectedActions(SilentlySave)
    }
