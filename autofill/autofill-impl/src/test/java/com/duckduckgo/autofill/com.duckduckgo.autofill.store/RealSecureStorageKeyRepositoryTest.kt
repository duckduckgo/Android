...
class RealSecureStorageKeyRepositoryTest {
    private val keyStore: com.duckduckgo.autofill.store.keys.SecureStorageKeyStore = mock()
    private lateinit var testee: com.duckduckgo.autofill.store.RealSecureStorageKeyRepository
    private val testValue = "TestValue".toByteArray()

    @Before
    fun setUp() {
        testee = com.duckduckgo.autofill.store.RealSecureStorageKeyRepository(keyStore)
    }
