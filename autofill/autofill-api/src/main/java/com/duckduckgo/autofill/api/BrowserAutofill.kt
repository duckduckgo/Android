...
interface Callback {
     ...
     */
    fun showNativeChooseEmailAddressPrompt(autofillUrlRequest: AutofillUrlRequest)

    /**
     * Called when the user should be shown prompt to sign up for Email Protection
     */
    fun showNativeInContextEmailProtectionSignupPrompt(autofillUrlRequest: AutofillUrlRequest)
