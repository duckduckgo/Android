...
class FakePrivacyDashboardRemoteFeatureFactory private constructor() {
    companion object {
        fun create(): PrivacyDashboardRemoteFeature {
            return FeatureToggles.Builder()
                ...
                .featureName("fakePrivacyDashboardRemoteFeature")
                .build()
                .create(PrivacyDashboardRemoteFeature::class.java)
        }
    }
}
