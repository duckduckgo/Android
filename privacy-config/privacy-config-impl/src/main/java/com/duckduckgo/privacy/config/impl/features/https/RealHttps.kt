...
class RealHttps @Inject constructor(
    ...
    private val whiteListRepository: UserWhiteListRepository,
) : Https {

    override fun isAnException(url: String): Boolean {
        return unprotectedTemporary.isAnException(url) || matches(url) || whiteListRepository.isUrlInAllowList(url)
    }
