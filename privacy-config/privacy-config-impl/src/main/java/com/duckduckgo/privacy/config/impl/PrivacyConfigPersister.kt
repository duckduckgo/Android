...
class RealPrivacyConfigPersister @Inject constructor(
    ...
    private val privacyConfigPersisterCallbackPlugin: PluginPoint<PrivacyConfigPersisterCallbackPlugin>,
    ...
    override suspend fun persistPrivacyConfig(
        ...
        if (shouldPersist) {
            ...
            privacyConfigPersisterCallbackPlugin.getPlugins().forEach {
