...
class PrivacyConfigLocalExceptionsReferenceTest(private val testCase: TestCase) {
    ...
    companion object {
        ...
        fun testData(): List<TestCase> {
            ...
            return referenceTest.localExceptions.tests.filterNot {
    ...
    private fun testFeatureEnabledForContentBlocking() {
        testee =
            RealContentBlocking(
                referenceTestUtilities.contentBlockingRepository, mockFeatureToggle, mock())
    ...
    data class ReferenceTest(val localExceptions: LocalExceptionsTest)
}
