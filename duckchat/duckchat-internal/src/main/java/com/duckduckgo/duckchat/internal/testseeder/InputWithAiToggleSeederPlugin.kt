...
class InputWithAiToggleSeederPlugin @Inject constructor(
    private val duckChat: DuckChat,
) : TestSeederPlugin {

    override val handledKeys = setOf(TestSeederKey.INPUT_WITH_AI_TOGGLE.key)

    override suspend fun apply(key: String, value: String) {
        duckChat.setInputScreenUserSetting(value == "true")
    }
}
