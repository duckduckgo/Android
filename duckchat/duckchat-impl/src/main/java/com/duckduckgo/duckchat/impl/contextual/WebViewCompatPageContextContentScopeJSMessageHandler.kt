...
class WebViewCompatPageContextContentScopeJSMessageHandler @Inject constructor() : WebViewCompatContentScopeJsMessageHandlersPlugin {
    ...
    override fun getJsMessageHandler(): WebViewCompatMessageHandler = object : WebViewCompatMessageHandler {
        ...
        override val featureName: String = "pageContext"
        override val methods: List<String> = listOf("collectionResult")
    }
}
