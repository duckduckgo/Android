...
class WebViewCompatStoreMigrationDataHandler @Inject constructor() : WebViewCompatContentScopeJsMessageHandlersPlugin {
...
@ContributesMultibinding(AppScope::class)
class WebViewCompatGetMigrationInfoHandler @Inject constructor() : WebViewCompatContentScopeJsMessageHandlersPlugin {
...
@ContributesMultibinding(AppScope::class)
class WebViewCompatGetMigrationDataByIndexHandler @Inject constructor() : WebViewCompatContentScopeJsMessageHandlersPlugin {
...
@ContributesMultibinding(AppScope::class)
class WebViewCompatClearMigrationDataHandler @Inject constructor() : WebViewCompatContentScopeJsMessageHandlersPlugin {
