...
class PproPixelParamsAdditionPlugin @Inject constructor(
    ...
    override fun isEligible(queryParams: Map<String, String>): Boolean {
        val origin = queryParams["origin"]
        return origin != null && additionalPixelParamsDataStore.includedOrigins.contains(origin)
    }
