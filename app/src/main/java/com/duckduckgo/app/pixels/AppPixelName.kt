...
enum class AppPixelName(override val pixelName: String) : Pixel.PixelName {
    ...
    FIRE_TABS_PROMO_NTP_SHOWN("m_fire_tabs_promo_ntp_shown"),
    FIRE_TABS_PROMO_NTP_CTA("m_fire_tabs_promo_ntp_cta"),
    FIRE_TABS_PROMO_NTP_DISMISSED("m_fire_tabs_promo_ntp_dismissed"),
