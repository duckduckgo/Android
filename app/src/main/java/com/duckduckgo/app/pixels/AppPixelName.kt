...
enum class AppPixelName(override val pixelName: String) : Pixel.PixelName {
    ...
    EXPERIMENTAL_MENU_USED_DAILY("m_experimental-browsing-menu_used_daily"),
    EXPERIMENTAL_MENU_ENABLED("m_experimental-browsing-menu_enabled"),
    EXPERIMENTAL_MENU_ENABLED_UNIQUE("m_experimental-browsing-menu_enabled_unique"),
    EXPERIMENTAL_MENU_ENABLED_DAILY("m_experimental-browsing-menu_enabled_daily"),
    EXPERIMENTAL_MENU_DISABLED("m_experimental-browsing-menu_disabled"),
    EXPERIMENTAL_MENU_DISABLED_UNIQUE("m_experimental-browsing-menu_disabled_unique"),
    EXPERIMENTAL_MENU_DISABLED_DAILY("m_experimental-browsing-menu_disabled_daily"),
    ...
    EXPERIMENTAL_MENU_ACTION_NAVIGATE_BACK_PRESSED("m_sheet-menu_nb_p"),
    EXPERIMENTAL_MENU_ACTION_NAVIGATE_FORWARD_PRESSED("m_sheet-menu_nf_p"),
    EXPERIMENTAL_MENU_ACTION_REFRESH_PRESSED("m_sheet-menu_r_p"),
    EXPERIMENTAL_MENU_CUSTOM_TABS_MENU_REFRESH("m_custom_tabs_sheet-menu_refresh"),
    EXPERIMENTAL_MENU_CUSTOM_TABS_OPEN_IN_DDG("m_sheet-menu_custom_tabs_open_in_ddg"),
    EXPERIMENTAL_MENU_CUSTOM_TABS_MENU_DISABLE_PROTECTIONS_ALLOW_LIST_ADD("m_custom_tabs_sheet-menu_disable_protections_allow_list_add"),
    EXPERIMENTAL_MENU_CUSTOM_TABS_MENU_DISABLE_PROTECTIONS_ALLOW_LIST_REMOVE("m_custom_tabs_sheet-menu_disable_protections_allow_list_remove"),
    EXPERIMENTAL_MENU_ACTION_NEW_TAB_PRESSED_FROM_SERP("m_sheet-menu_new_tab_open_from_serp"),
    EXPERIMENTAL_MENU_ACTION_NEW_TAB_PRESSED_FROM_SITE("m_sheet-menu_new_tab_open_from_website"),
    EXPERIMENTAL_MENU_DUCK_CHAT_OPEN_BROWSER_MENU("sheet-menu_aichat_open_browser_menu"),
    EXPERIMENTAL_MENU_DUCK_CHAT_SETTINGS_NEW_CHAT_TAB_TAPPED("m_aichat_settings_sheet-menu_new_chat_tab_tapped"),
    EXPERIMENTAL_MENU_DUCK_CHAT_OMNIBAR_NEW_CHAT_TAPPED("m_aichat_omnibar_sheet-menu_new_chat_button_tapped"),
    EXPERIMENTAL_MENU_DUCK_CHAT_SETTINGS_SIDEBAR_TAPPED("m_aichat_settings_sheet-menu_sidebar_tapped"),
    EXPERIMENTAL_MENU_DUCK_CHAT_DUCK_AI_SETTINGS_TAPPED("m_aichat_settings_sheet-menu_aichat_settings_tapped"),
    EXPERIMENTAL_MENU_ACTION_ADD_BOOKMARK_PRESSED("m_sheet-menu_ab_p"),
    EXPERIMENTAL_MENU_ACTION_EDIT_BOOKMARK_PRESSED("m_sheet-menu_eb_p"),
    EXPERIMENTAL_MENU_ACTION_SHARE_PRESSED("m_sheet-menu_sh_p"),
    EXPERIMENTAL_MENU_ACTION_FIND_IN_PAGE_PRESSED("m_sheet-menu_fip_p"),
    EXPERIMENTAL_MENU_ACTION_PRINT_PRESSED("m_sheet-menu_print_menu_item_pressed"),
    EXPERIMENTAL_MENU_ACTION_ADD_TO_HOME_PRESSED("m_sheet-menu_ath_p"),
    EXPERIMENTAL_MENU_ACTION_DESKTOP_SITE_ENABLE_PRESSED("m_sheet-menu_dse_p"),
    EXPERIMENTAL_MENU_ACTION_DESKTOP_SITE_DISABLE_PRESSED("m_sheet-menu_dsd_p"),
    EXPERIMENTAL_MENU_ACTION_REPORT_BROKEN_SITE_PRESSED("m_sheet-menu_rbs_p"),
    EXPERIMENTAL_MENU_ACTION_SETTINGS_PRESSED("m_sheet-menu_s_p"),
    EXPERIMENTAL_MENU_ACTION_APP_LINKS_OPEN_PRESSED("m_sheet-menu_app_links_open_menu_item_pressed"),
    EXPERIMENTAL_MENU_ACTION_BOOKMARKS_PRESSED("m_sheet-menu_bookmarks_menu_item_pressed"),
    EXPERIMENTAL_MENU_ACTION_DOWNLOADS_PRESSED("m_sheet-menu_downloads_menu_item_pressed"),
    EXPERIMENTAL_MENU_ACTION_AUTOFILL_PRESSED("m_sheet-menu_autofill_menu_item_pressed"),
    EXPERIMENTAL_MENU_FIREPROOF_WEBSITE_ADDED("m_sheet-menu_fw_a"),
    EXPERIMENTAL_MENU_FIREPROOF_WEBSITE_REMOVE("m_sheet-menu_fw_r"),
    EXPERIMENTAL_MENU_ALLOWLIST_ADD("mb_sheet-menu_wla"),
    EXPERIMENTAL_MENU_ALLOWLIST_REMOVE("mb_sheet-menu_wlr"),
    EXPERIMENTAL_MENU_SET_AS_DEFAULT_IN_MENU_CLICK("m_sheet-menu_set-as-default_in-menu_click"),
    EXPERIMENTAL_MENU_EMAIL_COPIED_TO_CLIPBOARD("sheet-menu_email_generated_button"),
