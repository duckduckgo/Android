...
/**
 * Implementation of DataClearing that provides granular data clearing capabilities.
 * This uses the FireDataStore to determine which data to clear based on user preferences.
 */
@ContributesBinding(AppScope::class)
@SingleInstanceIn(AppScope::class)
class RealDataClearing @Inject constructor(
    ...
    override suspend fun clearDataUsingManualFireOptions(shouldRestartProcess: Boolean) {
        ...
        if (shouldRestartProcess && wasDataCleared) {
            ...
            clearDataAction.setAppUsedSinceLastClearFlag(true)
        }
    }
