...
import com.duckduckgo.app.settings.messaging.RealSettingsJSHelper.Companion.METHOD_OPEN_NATIVE_SETTINGS
import com.duckduckgo.app.settings.messaging.RealSettingsJSHelper.Companion.SERP_SETTINGS_FEATURE_NAME
...
class SettingsContentScopeJsMessageHandler @Inject constructor() : ContentScopeJsMessageHandlersPlugin {
    override fun getJsMessageHandler(): JsMessageHandler = object : JsMessageHandler {
        ...
        override val featureName: String = SERP_SETTINGS_FEATURE_NAME
