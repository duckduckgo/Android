...
interface OnboardingDesignExperimentToggles {
    ...
    enum class Cohorts(override val cohortName: String) : Toggle.State.CohortName {
...
class OnboardingExperimentMetricsPixelPlugin @Inject constructor(
    ...
    suspend fun getSecondSearchVisitMetric(): MetricsPixel? {
        return this.getMetrics().firstOrNull { it.metric == METRIC_SECOND_SERP_VISIT }
    }

    companion object {
        internal const val METRIC_INTRO_SCREEN_DISPLAYED = "introScreenDisplayed"
        internal const val METRIC_COMPARISON_SCREEN_DISPLAYED = "comparisonScreenDisplayed"
        internal const val METRIC_CHOOSE_BROWSER = "chooseBrowser"
        internal const val METRIC_SET_DEFAULT_RATE = "setDefaultRate"
        internal const val METRIC_SET_ADDRESS_BAR_DISPLAYED = "setAddressBarDisplayed"
        internal const val METRIC_ADDRESS_BAR_SET_TOP = "addressBarSetTop"
        internal const val METRIC_ADDRESS_BAR_SET_BOTTOM = "addressBarSetBottom"
        internal const val METRIC_TRY_A_SEARCH_DISPLAYED = "tryASearchDisplayed"
        internal const val METRIC_FIRST_SEARCH_SUGGESTION = "firstSearchSuggestion"
        internal const val METRIC_SECOND_SEARCH_SUGGESTION = "secondSearchSuggestion"
        internal const val METRIC_THIRD_SEARCH_SUGGESTION = "thirdSearchSuggestion"
        internal const val METRIC_SEARCH_OR_NAV_CUSTOM = "searchOrNavCustom"
        internal const val METRIC_MESSAGE_ON_SERP_DISPLAYED = "messageOnSERPDisplayed"
        internal const val METRIC_VISIT_SITE_PROMPT_DISPLAYED_ADJACENT = "visitSitePromptDisplayedAdjacent"
        internal const val METRIC_VISIT_SITE_PROMPT_DISPLAYED_NEW_TAB = "visitSitePromptDisplayedNewTab"
        internal const val METRIC_FIRST_SITE_SUGGESTION = "firstSiteSuggestion"
        internal const val METRIC_SECOND_SITE_SUGGESTION = "secondSiteSuggestion"
        internal const val METRIC_THIRD_SITE_SUGGESTION = "thirdSiteSuggestion"
        internal const val METRIC_TRACKERS_BLOCKED_MESSAGE_DISPLAYED = "trackersBlockedMessageDisplayed"
        internal const val METRIC_NO_TRACKERS_MESSAGE_DISPLAYED = "noTrackersMessageDisplayed"
        internal const val METRIC_TRACKER_NETWORK_MESSAGE_DISPLAYED = "trackerNetworkMessageDisplayed"
        internal const val METRIC_PRIVACY_DASH_CLICKED_FROM_ONBOARDING = "privacyDashClickedFromOnboarding"
        internal const val METRIC_FIRE_BUTTON_PROMPT_DISPLAYED = "fireButtonPromptDisplayed"
        internal const val METRIC_FIRE_BUTTON_CLICKED_FROM_ONBOARDING = "fireButtonClickedFromOnboarding"
        internal const val METRIC_FINAL_ONBOARDING_SCREEN_DISPLAYED = "finalOnboardingScreenDisplayed"
        internal const val METRIC_SECOND_SITE_VISIT = "secondSiteVisit"
        internal const val METRIC_SECOND_SERP_VISIT = "secondSerpVisit"
    }
}
