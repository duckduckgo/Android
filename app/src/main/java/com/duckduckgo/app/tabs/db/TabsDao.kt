...
abstract class TabsDao {
    ...
    @Query("select tabId from tabs where url LIKE '%' || :urlPattern order by position desc limit 1")
    abstract suspend fun findTabIdByUrlPattern(urlPattern: String): String?
