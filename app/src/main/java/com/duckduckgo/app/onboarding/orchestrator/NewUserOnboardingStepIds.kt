...
internal object NewUserOnboardingStepIds {
    ...
    const val PASSWORD_IMPORT: LinearOnboardingStepId = "password_import"
    const val PASSWORD_IMPORT_LAUNCH: LinearOnboardingStepId = "password_import_launch"
    const val PASSWORD_IMPORT_COMPLETE: LinearOnboardingStepId = "password_import_complete"
