...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        val easylistStream = resources.openRawResource(R.raw.easylist)
        val easylistData = easylistStream.use { it.readBytes() }
        val trackerDetector = TrackerDetector(easylistData)
