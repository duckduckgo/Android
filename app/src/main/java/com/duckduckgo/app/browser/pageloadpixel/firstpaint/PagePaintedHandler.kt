        ...
        return withContext(dispatcherProvider.main()) {
            suspendCoroutine { continuation ->
                evaluateJavascript("$PAGE_PAINT_JS") { value ->
                    Log.i("PagePainterHandler", "DDG PERF METRICS INJECTED")
