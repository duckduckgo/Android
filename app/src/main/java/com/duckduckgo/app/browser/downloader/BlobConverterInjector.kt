...
interface BlobConverterInjector {
    fun addJsInterface(webView: WebView, onBlobTransformed: (url: String, mimeType: String) -> Unit)
    fun convertBlobIntoDataUriAndDownload(webView: WebView, blobUrl: String, contentType: String?)
}
