...
import com.duckduckgo.app.browser.omnibar.UnifiedOmnibarLayoutViewModel.Command
import com.duckduckgo.app.browser.omnibar.UnifiedOmnibarLayoutViewModel.Command.LaunchInputScreen
import com.duckduckgo.app.browser.omnibar.UnifiedOmnibarLayoutViewModel.Command.MoveCaretToFront
import com.duckduckgo.app.browser.omnibar.UnifiedOmnibarLayoutViewModel.Command.StartCookiesAnimation
import com.duckduckgo.app.browser.omnibar.UnifiedOmnibarLayoutViewModel.Command.StartTrackersAnimation
...
import com.duckduckgo.app.browser.omnibar.UnifiedOmnibarLayoutViewModel.ViewState
...
open class UnifiedOmnibarLayout @JvmOverloads constructor(
    ...
    protected val viewModel: UnifiedOmnibarLayoutViewModel by lazy {
        ViewModelProvider(
            findViewTreeViewModelStoreOwner()!!,
            viewModelFactory,
        )[UnifiedOmnibarLayoutViewModel::class.java]
    }
    ...
    private fun renderLeadingIconState(viewState: ViewState) {
        when (val leadingIconState = viewState.leadingIconState) {
            UnifiedOmnibarLayoutViewModel.LeadingIconState.Search -> {
                searchIcon.show()
                shieldIcon.gone()
                daxIcon.gone()
                globeIcon.gone()
            ...
            UnifiedOmnibarLayoutViewModel.LeadingIconState.Dax -> {
            ...
            UnifiedOmnibarLayoutViewModel.LeadingIconState.Globe -> {
                globeIcon.show()
                daxIcon.gone()
                shieldIcon.gone()
                searchIcon.gone()
            ...
            UnifiedOmnibarLayoutViewModel.LeadingIconState.DuckPlayer -> {
                globeIcon.gone()
                daxIcon.gone()
                shieldIcon.gone()
                searchIcon.gone()
