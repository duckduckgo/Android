...
/** Let's Encrypt R3 intermediate certificate. It is signed by [IsrgRootX1] */
class LetsEncryptR3(private val context: Context) : LetsEncryptCertificate {
    ...
    private val certificate: Certificate by lazy {
        ...
        val certificate =
            certificateFactory.generateCertificate(
                context.resources.openRawResource(R.raw.lets_encrypt_r3))
        certificate
    }
