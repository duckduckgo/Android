...
import com.duckduckgo.app.browser.defaultbrowsing.prompts.DefaultBrowserPromptsExperimentMetrics.Companion.METRIC_DEFAULT_SET
import com.duckduckgo.app.browser.defaultbrowsing.prompts.DefaultBrowserPromptsExperimentMetrics.Companion.METRIC_DEFAULT_SET_VIA_CTA
import com.duckduckgo.app.browser.defaultbrowsing.prompts.DefaultBrowserPromptsExperimentMetrics.Companion.METRIC_STAGE_IMPRESSION
import com.duckduckgo.app.browser.defaultbrowsing.prompts.DefaultBrowserPromptsExperimentMetrics.Companion.METRIC_VALUE_DIALOG
import com.duckduckgo.app.browser.defaultbrowsing.prompts.DefaultBrowserPromptsExperimentMetrics.Companion.METRIC_VALUE_ENROLLED
import com.duckduckgo.app.browser.defaultbrowsing.prompts.DefaultBrowserPromptsExperimentMetrics.Companion.METRIC_VALUE_MENU
import com.duckduckgo.app.browser.defaultbrowsing.prompts.DefaultBrowserPromptsExperimentMetrics.Companion.METRIC_VALUE_STAGE_1
import com.duckduckgo.app.browser.defaultbrowsing.prompts.DefaultBrowserPromptsExperimentMetrics.Companion.METRIC_VALUE_STAGE_2
...
class DefaultBrowserPromptsExperimentMetrics @Inject constructor(
    ...
    suspend fun getDefaultSetForEnrolled(): MetricsPixel? {
        return this.getMetrics().firstOrNull { it.metric == METRIC_DEFAULT_SET && it.value == METRIC_VALUE_ENROLLED }
    }
    ...
    companion object {
        ...
        const val METRIC_VALUE_ENROLLED = "enrolled"
