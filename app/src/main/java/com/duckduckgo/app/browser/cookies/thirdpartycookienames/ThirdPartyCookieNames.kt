...
class RealThirdPartyCookieNames @Inject constructor(
    private val thirdPartyCookieNamesFeature: ThirdPartyCookieNamesFeature,
    ...
    override fun hasExcludedCookieName(cookieString: String): Boolean {
        return thirdPartyCookieNamesFeature.self().isEnabled() &&
            thirdPartyCookieNamesSettingsRepository.cookieNames.any { cookieString.contains(it) }
    }
}
