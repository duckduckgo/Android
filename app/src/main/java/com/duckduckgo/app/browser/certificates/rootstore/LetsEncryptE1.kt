...
/** Let's Encrypt E1 intermediate certificate. It is signed by [IsrgRootX2] */
class LetsEncryptE1(private val context: Context) : LetsEncryptCertificate {
    ...
    private val certificate: Certificate by lazy {
        ...
        val certificate =
            certificateFactory.generateCertificate(
                context.resources.openRawResource(R.raw.lets_encrypt_e1))
        certificate
    }
