 ...
 *
 * <p>This is an approximation of the detection and could potentially lead to misleading advice. If
 * we hit problems with it, remove the detection and replace with a suggestive error message
 * instead, like "Negative page offset encountered. Did you setAnimateParentHierarchy(false) to all
 * your LayoutTransitions?".
 */
