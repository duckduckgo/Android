...
class OmnibarLayout @JvmOverloads constructor(
    ...
    private fun cancelEasterEggLogoAnimation() {
        // Cancel any pending postDelayed animation
        daxIcon.removeCallbacks(null)
        // Cancel the running ObjectAnimator
        SerpEasterEggLogoAnimator.cancel()
        // Reset rotation (caller owns the view, we reset it here)
        daxIcon.rotation = 0f
    }
    ...
    private inner class EasterEggLogoListener(
        ...
        override fun onResourceReady(
            ...
            if (!leadingIconState.isFavourite && logoUrl != lastAnimatedLogoUrl) {
                ...
                daxIcon.postDelayed({
                    SerpEasterEggLogoAnimator.playWiggle(daxIcon)
