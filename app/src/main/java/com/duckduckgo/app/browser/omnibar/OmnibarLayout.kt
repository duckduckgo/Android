...
open class OmnibarLayout @JvmOverloads constructor(
    ...
    private fun renderLeadingIconState(viewState: ViewState) {
        when (val leadingIconState = viewState.leadingIconState) {
            ...
            OmnibarLayoutViewModel.LeadingIconState.PrivacyShield -> {
            ...
            is EasterEggLogo -> {
                daxIcon.show()
                ViewCompat.setTransitionName(daxIcon, leadingIconState.url)
                Glide.with(daxIcon)
                    .load(leadingIconState.url)
                    .placeholder(daxIcon.drawable)
                    .transition(withCrossFade())
                    .override(24.toPx())
                    .fitCenter()
    ...
    private fun renderPrivacyShield(
        privacyShield: com.duckduckgo.app.global.model.PrivacyShield,
        viewMode: ViewMode,
