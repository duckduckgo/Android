...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private final @NonNull TabPager mViewPager;
    ...
    ScrollEventAdapter(@NonNull TabPager viewPager) {
    ...
    /**
     * This method only deals with some cases of {@link AdapterState} transitions. The rest of the
     * state transition implementation is in the {@link #onScrolled} method.
     */
    @Override
    ...
    /**
     * This method only deals with some cases of {@link AdapterState} transitions. The rest of the
     * state transition implementation is in the {@link #onScrollStateChanged} method.
     */
    @Override
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        if (mDispatchSelected) {
            ...
            mTarget =
                    scrollingForward && mScrollValues.mOffsetPx != 0
        ...
        dispatchScrolled(
                mScrollValues.mPosition == NO_POSITION ? 0 : mScrollValues.mPosition,
                mScrollValues.mOffset,
                mScrollValues.mOffsetPx);
    ...
    void notifyProgrammaticScroll(int target, boolean smooth) {
        mAdapterState =
                smooth ? STATE_IN_PROGRESS_SMOOTH_SCROLL : STATE_IN_PROGRESS_IMMEDIATE_SCROLL;
     ...
     * page, the returned value will be between 1 and 2. Thus, non-integral values mean that the the
     * ViewPager is settling towards its {@link ViewPager2#getCurrentItem() current item}, or the
     * user may be dragging it.
     *
