...
class BrowserTabFragment :
    ...
    private val autofillCallback = object : Callback {
        ...
        override suspend fun onGeneratedPasswordAvailableToUse(
            ...
            withContext(dispatchers.main()) {
                showUserAutoGeneratedPasswordDialog(originalUrl, generatedPassword)
            }
        }
        ...
        private fun showUserAutoGeneratedPasswordDialog(
            ...
            val dialog = credentialAutofillDialogFactory.autofillGeneratePasswordDialog(url, generatedPassword, tabId)
            showDialogHidingPrevious(dialog, GenerateSecurePasswordDialog.TAG, originalUrl)
        }
    ...
    private fun configureWebViewForAutofill(it: DuckDuckGoWebView) {
        ...
        setFragmentResultListener(GenerateSecurePasswordDialog.resultKey(tabId)) { _, result ->
            launch {
                autofillCredentialsSelectionResultHandler.processGeneratePasswordResult(result, viewModel)
            }
        }
    }
