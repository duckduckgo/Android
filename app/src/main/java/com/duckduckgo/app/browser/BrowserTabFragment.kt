...
import com.duckduckgo.youtubeadblocking.impl.YouTubeAdBlockingAdsJsPlugin
...
class BrowserTabFragment :
    ...
    @Inject
    lateinit var youTubeAdBlockingAdsJsPlugin: YouTubeAdBlockingAdsJsPlugin
    ...
    private fun configureWebViewForYouTubeAdBlocking(webView: DuckDuckGoWebView) {
        lifecycleScope.launch {
            youTubeAdBlockingAdsJsPlugin.addDocumentStartJavaScript(webView)
        }
    }
