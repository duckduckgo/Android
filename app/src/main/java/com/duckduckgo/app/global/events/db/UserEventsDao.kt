...
interface UserEventsDao {
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE) fun insert(userEventEntity: UserEventEntity)

    @Query("delete from user_events where id=:userEventKey") fun delete(userEventKey: UserEventKey)
}
