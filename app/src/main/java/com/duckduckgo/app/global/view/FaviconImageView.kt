...
fun generateDefaultDrawable(context: Context, domain: String): Drawable {
    return object : Drawable() {
        ...
        private val faviconDefaultCornerRadius =
            context.resources.getDimension(R.dimen.savedSiteGridItemCornerRadiusFavicon)
        private val faviconDefaultSize =
            context.resources.getDimension(R.dimen.savedSiteGridItemFavicon)
        ...
        private val backgroundPaint =
            Paint(Paint.ANTI_ALIAS_FLAG).apply { color = domainToColor(baseHost) }
        ...
        private fun domainToColor(domain: String): Int {
            return domain
                .encodeUtf8()
                .toByteArray()
                .fold(5381L) { acc, byte -> (acc shl 5) + acc + byte.toLong() }
                .absoluteValue
                .let {
