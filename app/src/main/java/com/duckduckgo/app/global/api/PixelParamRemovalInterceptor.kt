...
object PixelInterceptorPixelsRequiringDataCleaning : PixelParamRemovalPlugin {
    override fun names(): List<Pair<String, Set<PixelParameter>>> {
        return listOf(
            ...
            AppPixelName.ONBOARDING_WELCOME.pixelName to PixelParameter.removeAtb(),
            AppPixelName.ONBOARDING_SET_DEFAULT.pixelName to PixelParameter.removeAtb(),
            AppPixelName.ONBOARDING_ADDRESS_BAR_POSITION.pixelName to PixelParameter.removeAtb(),
