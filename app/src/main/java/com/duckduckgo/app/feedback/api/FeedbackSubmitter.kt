...
class FireAndForgetFeedbackSubmitter(
    ...
    override suspend fun sendNegativeFeedback(
        ...
        Timber.i(
            "User provided negative feedback: {$openEnded}. mainReason = $mainReason, subReason = $subReason")
    ...
    override suspend fun sendBrokenSiteFeedback(openEnded: String, brokenSite: String?) {
        Timber.i(
            "User provided broken site report through feedback, url:{$brokenSite}, comment:{$openEnded}")
    ...
    private fun pixelForNegativeFeedback(category: String, subcategory: String): String {
        return String.format(
            Locale.US,
            FEEDBACK_NEGATIVE_SUBMISSION.pixelName,
            NEGATIVE_FEEDBACK,
            category,
            subcategory)
    }
    ...
    private fun pixelForPositiveFeedback(): String {
        return String.format(
            Locale.US, AppPixelName.FEEDBACK_POSITIVE_SUBMISSION.pixelName, POSITIVE_FEEDBACK)
    }
