...
class BrowserTabViewModelTest {
    ...
    @Test
    fun whenUserSubmittedQueryIfGpcIsEnabledThenDoNotAddHeaderToUrl() {
        whenever(mockOmnibarConverter.convertQueryToUrl("foo", null)).thenReturn("foo.com")
    ...
    @Test
    fun whenOnDesktopSiteModeToggledIfGpcIsEnabledThenDoNotAddHeaderToUrl() {
        whenever(mockSettingsStore.globalPrivacyControlEnabled).thenReturn(false)
        loadUrl("http://m.example.com")
    ...
    @Test
    fun whenExternalAppLinkClickedIfGpcIsEnabledThenDoNotAddHeaderToUrl() {
        whenever(mockSettingsStore.globalPrivacyControlEnabled).thenReturn(false)
        val intentType = SpecialUrlDetector.UrlType.IntentType("query", mock(), null)
