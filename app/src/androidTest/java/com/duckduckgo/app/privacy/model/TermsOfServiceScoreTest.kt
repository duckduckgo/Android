...
class TermsOfServiceScoreTest(private val testCase: TermsOfServiceScoreTestCase) {

    @Test
    fun test() {
        assertEquals(testCase.expectedScore, testCase.terms.derivedScore)
    }
    ...
    companion object {
        ...
        fun data(): Array<TermsOfServiceScoreTestCase> {
            return arrayOf(
                // scores
