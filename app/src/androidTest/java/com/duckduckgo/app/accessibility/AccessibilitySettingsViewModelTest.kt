...
class AccessibilitySettingsViewModelTest {
    ...
    @Test
    fun whenViewModelCreatedThenDefaultViewStateEmitted() =
        coroutineRule.runBlocking {
            val viewState =
                AccessibilitySettingsViewModel.ViewState(
                    overrideSystemFontSize = false, appFontSize = 100f, forceZoom = false)
    ...
    @Test
    fun whenViewModelStartedThenViewStateEmitted() =
        coroutineRule.runBlocking {
            val viewState =
                AccessibilitySettingsViewModel.ViewState(
                    overrideSystemFontSize = true, appFontSize = 150f, forceZoom = true)
    ...
    @Test
    fun whenForceZoomEnabledThenViewStateEmitted() =
        coroutineRule.runBlocking {
    ...
    @Test
    fun whenForceZoomEnabledThenSettingsUpdated() =
        coroutineRule.runBlocking {
            whenever(accessibilitySettings.forceZoom).thenReturn(true)
    ...
    @Test
    fun whenOverrideSystemFontSizeEnabledThenViewStateEmitted() =
        coroutineRule.runBlocking {
            val viewState = defaultViewState()
            whenever(accessibilitySettings.overrideSystemFontSize).thenReturn(true)
    ...
    @Test
    fun whenOverrideSystemFontSizeEnabledThenSettingsUpdated() =
        coroutineRule.runBlocking {
            whenever(accessibilitySettings.overrideSystemFontSize).thenReturn(true)
    ...
    @Test
    fun whenFontSizeChangedThenViewStateEmitted() =
        coroutineRule.runBlocking {
            val viewState = defaultViewState()
            whenever(accessibilitySettings.appFontSize).thenReturn(150f)
    ...
    @Test
    fun whenFontSizeChangedThenSettingsUpdated() =
        coroutineRule.runBlocking {
            whenever(accessibilitySettings.appFontSize).thenReturn(150f)
