...
private class FlipperPluginPluginPoint(private val plugins: DaggerSet<FlipperPlugin>) :
...
abstract class FlipperPluginModule {
    @Multibinds abstract fun bindEmptySettingInternalFeaturePlugins(): DaggerSet<FlipperPlugin>
