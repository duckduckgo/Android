...
class DefaultVoiceSearchAvailabilityTest {

    @Mock
    private lateinit var configProvider: VoiceSearchAvailabilityConfigProvider

    private lateinit var testee: DefaultVoiceSearchAvailability

    @Before
    fun setUp() {
        MockitoAnnotations.openMocks(this)
        testee = DefaultVoiceSearchAvailability(configProvider)
    }
