...
class TopOmnibarBrowserContainerLayoutBehaviorTest {
    ...
    @Test
    fun whenDependencyFullyExpandedThenMarginSetToVisibleHeightMinusOffset() {
        ...
        assertEquals(224 - marginOffsetPx, (child.layoutParams as CoordinatorLayout.LayoutParams).bottomMargin)
    }
