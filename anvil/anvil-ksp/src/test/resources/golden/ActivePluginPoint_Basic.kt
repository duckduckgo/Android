...
@ContributesPluginPoint(
  ...
  boundType = TestActivePlugin::class,
)
@Suppress("unused")
private interface Trigger_TestActivePlugin_ActivePluginPoint

@ContributesRemoteFeature(
  scope = AppScope::class,
  featureName = "pluginPointTestPlugin",
  toggleStore = TestActivePlugin_ActivePluginPoint_RemoteFeature_MultiProcessStore::class,
)
public interface TestActivePlugin_ActivePluginPoint_RemoteFeature {
  @Toggle.DefaultValue(defaultValue = DefaultFeatureValue.TRUE)
  public fun self(): Toggle
}

public class TestActivePlugin_PluginPoint_ActiveWrapper @Inject constructor(
  private val toggle: TestActivePlugin_ActivePluginPoint_RemoteFeature,
  private val pluginPoint: PluginPoint<@JvmSuppressWildcards TestActivePlugin>,
  private val dispatcherProvider: DispatcherProvider,
) : InternalActivePluginPoint<@JvmSuppressWildcards TestActivePlugin> {
  public override suspend fun getPlugins(): Collection<TestActivePlugin> =
...
@RemoteFeatureStoreNamed(value = TestActivePlugin_ActivePluginPoint_RemoteFeature::class)
public class TestActivePlugin_ActivePluginPoint_RemoteFeature_MultiProcessStore @Inject constructor(
  @AppCoroutineScope
...
public abstract class TestActivePlugin_PluginPoint_ActiveWrapper_Binding_Module {
  @Binds
  public abstract
      fun bindsTestActivePlugin_PluginPoint_ActiveWrapper(pluginPoint: TestActivePlugin_PluginPoint_ActiveWrapper):
      InternalActivePluginPoint<@JvmSuppressWildcards TestActivePlugin>
}
